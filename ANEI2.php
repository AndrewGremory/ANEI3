...
<?php
	...
	if($accion == 4)
	{
		...
		<div margin-right: 200px;>
		<p>Observaciones:</p>
	    <textarea class="form-control" name="observaciones" id="observaciones" rows="6" cols="10" placeholder="escriba aqui las observaciones" ></textarea><br>
		</div>
...
{ 	
		...
		{ 
		  ...
		  <div class="form-group row ">
			 ...
			 <div class="col-lg-3">
			 <div class="input-group mb-3 form-floating">
		     <input type="number" class="form-control" id="rendimiento" name="rendimiento" readonly value="'.$rendimiento.'" readonly><br>
			 <span class="input-group-text">✎</span>
		 ...
		 <div class="form-group row ">
	 	      <div class="col-lg-3">
		      <div class="input-group mb-3 form-floating">
		      <input type="number" class="form-control" id="bonificacion" name="bonificacion" onkeyup="boni()" required><br>
		      <span class="input-group-text">✎</span>
		...
		<div class="form-group row ">
		   ...
		   <div class="col-lg-6">
		   <p>Observaciones:</p>
	       <textarea class="form-control" name="observaciones_liquidacion" id="observaciones_liquidacion" rows="4" cols="20" placeholder="escriba aqui las observaciones"></textarea><br><br>
		   </div>
		   </div>
		  <div class="form-group row ">
		   <div class="offset-lg-1 col-lg-8">
...
{ 		
		...
		<div class="form-group row " style="margin-top: 45px;">
			<div class="col-lg-4">
			<div class="input-group mb-3 form-floating">
			<input type="text" class="form-control" id="nombre_analisisfisico" name="nombre_analisisfisico" value="'.$consul['nombre_usuario'].'" readonly ><br>
		    <span class="input-group-text">✎</span>
		    <label for="nombre" class="form-label">Nombre:</label>
		    </div>
		    </div>
	   ...
	   <div class="form-group row ">
	    ...
	    <div class="form-group row">
		 ...
		 <div class="form-group row">
			  ...
			  <div class="col-lg-9">
			  <div class="input-group mb-3 form-floating">
              <textarea name="observaciones_analisisfisico" id="observaciones_analisisfisico" rows="2" cols="70" placeholder="escriba aqui las observaciones"></textarea><br>
			  </div>  
		 </div>
		   ...
		   {  
			...
			{  $a=$a+1;
			 ...
			 <div class="form-group row">
                  ...
                  <div class="col-lg-4" style="margin-left:300px; margin-top:-90px;">
                  <div class="input-group mb-3 form-floating">
                  ...
                  <div class="col-lg-4" style="margin-left:600px; margin-top:-72px;">
                  <div class="input-group mb-3 form-floating">
	 ...
	 if($accion == 15)
	 {
		...
		{ 
			...
			<div class="form-group row ">
		         ...
		         <div class="col-lg-4" style="margin-top:-90px; margin-left:300px;">
		         <div class="input-group mb-3 form-floating">
	            ...
	            <div class="col-lg-4" style="margin-top:-72px; margin-left:600px;">
		        <div class="input-group mb-3 form-floating">
	       ...
	       <div class="form-group row">
				...
				<div class="col-lg-4" style="margin-left:-295px;">
		        <div class="input-group mb-3 form-floating">
				...
				<div class="col-lg-3" style="margin-top:-90px; margin-left:270px;">
		        <div class="input-group mb-3 form-floating">
				...
				<div class="col-lg-3" style="margin-top:-72px; margin-left:470px;">
		        <div class="input-group mb-3 form-floating">
				...
				<div class="col-lg-3" style="margin-top:-72px; margin-left:670px;">
		        <div class="input-group mb-3 form-floating">
	        ...
	        <div class="form-group row">
				 ...
				 <div class="col-lg-3" style="margin-top:-90px; margin-left:200px;">
			     <div class="input-group mb-3 form-floating">
				 ...
				 <div class="col-lg-7" style="margin-top:-72px; margin-left:400px;">
			     <div class="input-group mb-3 form-floating">
	             <textarea class="form-control"	 name="observaciones_resultado" id="observaciones_resultado" rows="2" cols="90"></textarea><br><br>
				 <span class="input-group-text">✎</span>
		...
		{ $total_retiro = $total_retiro + $consul['valor_retiro'];}
          ...
          $neto_ahorro=$total_ahorrado - $total_retiro;		
			...
			<div class="form-group row" style="margin-top:45px">
				 ...
				 <div class="col-lg-3" style="margin-left:305px; margin-top:-90px">
			     <div class="input-group mb-3 form-floating">
				 ...
				 <div class="col-lg-3" style="margin-left:532px; margin-top:-72px">
			     <div class="input-group mb-3 form-floating">
	        ...
	        <div class="form-group row ">
				 ...
				 <div class="col-lg-5" style="margin-left:380px; margin-top:-90px">
	             <div class="input-group mb-3 form-floating">
