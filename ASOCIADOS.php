...
<body  style="background-color: #dae09f">
		...
		<hr>
                    ...
                    <div class="row"> 
                        <div class="col-lg-3">
                         <div class="input-group mb-3 form-floating">
                            <input type="text" class="form-control" id="estatus" name="estatus"  value="estandar" placeholder="ESTATUS" readonly><br>
                            <span class="input-group-text">✎</span>
                      ...
                      <div class="col-lg-3">
                       <div class="input-group mb-3 form-floating">
                        <input type="number" class="form-control" id="cupo_cafe" name="cupo_cafe" min="0"  placeholder="CUPO CAFE"required><br>
                        <span class="input-group-text">✎</span>
                      ...
                      <div class="col-lg-3">
                        <div class="input-group mb-3 form-floating">
                            <input type="number" class="form-control" id="cupo_cacao" name="cupo_cacao" min="0" placeholder="CUPO CACAO" required><br>
                            <span class="input-group-text">✎</span>
...
<!-- ----------------- ASOCIADO--------------------------------->  
  function usuario()
    { 
     ...
     var cupo_cafe = document.getElementById("cupo_cafe").value
     var cupo_cacao = document.getElementById("cupo_cacao").value

      if (nombre_usuario == "" || cedula_usuario  == "" || contacto  == "" || codigo_up  == "" || municipio  == "" || vereda  == "" || finca  == "" || cupo_cafe  == "" || cupo_cacao == ""  ){
